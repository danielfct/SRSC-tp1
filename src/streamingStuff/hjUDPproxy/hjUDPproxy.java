package streamingStuff.hjUDPproxy;
...
class hjUDPproxy {
	public static void main(String[] args) throws Exception {
		try (InputStream inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/streamingStuff/hjUDPproxy/config.properties")) {
			...
			// If listen a remote unicast server taje the remote config  uncomment the following line
			// DatagramSocket inSocket = new DatagramSocket(inSocketAddress); 
			// If listen a remote multicast server in 239.9.9.9 port 9999 uncomment the following two lines
